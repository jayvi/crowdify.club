<div class="modal fade" id="modal-send-points">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h5 class="modal-title" id="myModalLabel">
                    <img src="{{url('assets/images/logo.png')}}" alt=""class="popup-logo">Send Points
                </h5>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="hidden" id="send-point-username" value="{{ $user->username }}" name="username">
                                    <input type="number" name="amount" value="" class="form-control" id="send-point-amount" placeholder="Enter Amount">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <input type="button" class="btn btn-default-outline btn-sm pull-right" id="button-send-point" value="Send">
                            </div>
                        </div>
                        @if($twitterProfile)
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="tweet">Tweet to get extra Crowdify Points</label>
