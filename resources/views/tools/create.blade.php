                ...
                <div class="col-md-7">
                    <div class="panel z1">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label id="url-name">http://tools.crowdify.tech/</label>
                                {{--{!! Form::label('name', 'http://tools.crowdify.tech/') !!}--}}
                                {!! Form::text('name', '', ['class' => 'form-control','placeholder' => 'Web tool url name','id' => 'webtool-url-name']) !!}
                                @if($errors->has('name'))
                                    <label class="text-danger">Please enter a valid url name. Use only Letters, Numbers, Dashes, and Underscores</label>
...
//                    });
            ...
            $('#url-name').text('http://tools.crowdify.tech/'+$('#webtool-url-name').val());


            $('#webtool-url-name').on('input',function(e){
                $('#url-name').text('http://tools.crowdify.tech/'+$(this).val());
            });
