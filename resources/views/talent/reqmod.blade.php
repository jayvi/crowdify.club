                    ...
                    <div class="col-md-8">
                            ...
                            <div class="panel-body">
                                ...
                                <span class="rf"
                                      style="margin: 0px; padding: 0px; border: 0px; outline: 0px; vertical-align: baseline; float: right; background: transparent;"><span
                                            class="fa fa-clock-o"
                                            style="font-size: 18px; margin: 0px 3px 0px 0px; padding: 0px; border: 0px; outline: 0px; vertical-align: middle; background: transparent;"></span>
                                    <div class="form-group">
                        ...
                        <div class="panel z1">
                            @foreach($ratings as $rating)
                                <div class="panel-body">
                                    <span> <a href="{{ route('perk::public_profile', array('username' => $rating->user->username)) }}">
                                            <img class="img-circle profile-avatar" src="{{$rating->user->avatar}}"/></a></span>
                                    {{$rating->feedback}}
                    ...
                    <div class="col-md-4 talent">
                        <div class="panel z1">
                            <div class="panel-body">
                                ...
                                <img src="{{ $user->avatar ? $user->avatar_original : '' }}"
                                     class="profile-avatar-big img-circle">
